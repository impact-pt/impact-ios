//
//  PhysicianSetLimitsViewController.swift
//  Capstone Homepage
//
...
class PhysicianSetLimitsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    var userid = String();
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "AddLimits"{
            let vc = segue.destination as! PhysicianEditLimitsViewController
