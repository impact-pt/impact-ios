//
//  ExerciseDatabaseViewController.swift
//  Capstone Homepage
//
...
class ExerciseDatabaseViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func addButtonTapped(_ sender: Any) {
        DispatchQueue.main.async {
            self.performSegue(withIdentifier: "AddExercise", sender: Any?.self)
        }
    }
    override func viewDidLoad() {
        super.viewDidLoad()
        guard let myUrl = URL(string: "http://cgi.sice.indiana.edu/~team13/exerciseDatabase.php") else{ return }
